...
<style>
    * {{
    ...
    /* One answer box for one scenario.
       The answer boxes are arranged as a clean 2 x 2 grid for Easy
       and a 2-column grid for modes with more scenarios. */
    .slots {{
        display: grid;
    ...
    /* Keep the BACK, RESTART and DONE row clearly separated
       from the scenario answer boxes. */
    .controls {{
        display: grid;
...
"""
    ...
    # Extra iframe height prevents the lower scenario boxes and the
    # three control buttons from being clipped or visually overlapping.
    component_height = 1540 if slot_count >= 6 else 1120
